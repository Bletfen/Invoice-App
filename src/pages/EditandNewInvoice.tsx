...
export default function EditandNewInvoice() {
  ...
  return (
    <>
      <div
        className="hidden md:block fixed bg-black/50 inset-0
        overflow-y-auto
        h-screen z-50
        "
        onClick={(e) => {
      ...
      <div
        className="absolute inset-0
          ...
          top-0
          xl:top-0 xl:left-33 xl:mx-0 xl:fixed
          xl:w-[71.9rem]
          md:pt-[5.9rem]
          z-60
          "
      >
        ...
        <div
          className={`flex gap-[0.8rem] ${
            isEdit ? "md:justify-end" : "md:justify-between"
          }
